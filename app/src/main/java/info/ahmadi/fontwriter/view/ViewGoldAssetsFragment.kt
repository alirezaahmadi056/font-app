...
import info.ahmadi.fontwriter.databinding.FragmentGoldAssetsBinding
...
@FragmentScoped
class ViewGoldAssetsFragment @Inject constructor(@ActivityContext context: Context):FrameLayout(context) {
    val binding = FragmentGoldAssetsBinding.inflate(LayoutInflater.from(context))
    @Inject
